...
\addbibresource{references-lit.bib} % The filename of the bibliography
...
\supervisor{Dr.Ing Mohammed \textsc{El-hajj} T.M.  \textsc{ITÄPELTO}(Ph.D.)} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
