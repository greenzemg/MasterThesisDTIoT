...
\thesistitle{Securing Application of Digital Twin and IoT in Industry 4.0 Using Lightweight Authenticated Encrypted Payload} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
